...
- Social — demografía, hábitos de consumo, cultura, educación
- Tecnológico — innovación, infraestructura, obsolescencia, adopción
- Ecológico — clima, sostenibilidad, presión ambiental, residuos
- Legal — leyes, normativa de datos, laboral, propiedad intelectual

### Microentorno
- Clientes — a quiénes les vendés
- Proveedores — de quiénes dependés
- Competidores — contra quiénes jugás
...
- 2 Ayudar a evaluar — que puedan comparar y decidir
- 3 Permitir comprar — que puedan cerrar la operación
- 4 Entregar valor — que reciban lo prometido
- 5 Postventa — soporte, fidelización y reclamos

### Upselling y cross-selling
- Upselling ⬆ — versión mejor del mismo producto, subís de gama
...
- Foco en el control
- El PM es un controlador

### PMBOK 7, adaptable
- Estructura: 12 principios + 8 dominios
- Éxito = valor entregado
- Foco en la adaptación (tailoring)
- El PM es líder e integrador
...
- Conocimiento — saber de gestión de proyectos
- Desempeño — aplicarlo y lograr resultados
...
- Poder bajo + interés bajo → monitorear, esfuerzo mínimo
- No es estática: sirve para mapear aliados y opositores, y se revisa por fase

### Objetivos SMART
- eSpecífico — qué exactamente
- Medible — con qué número se verifica
- Alcanzable — realista con los recursos
...
### DCD
- Dato — el número o el hecho
- Contexto — qué significa respecto del plan
- Decisión — qué hacemos o qué pido

### CSAD
- Contexto — ¿dónde estábamos? ¿qué esperábamos?
...
- Inherente: la exposición sin mitigación, antes de los controles
...
- Son cosas que no están escritas en ningún lado y por eso la máquina no las puede tener

### Framework RCTF
- Rol: quién es la IA («actuá como PM senior de...»)
- Contexto: cuál es la situación, datos del proyecto
- Tarea: qué tiene que producir exactamente
- Formato: cómo lo entrega (tabla, columnas, orden)
...
- 2 Diseño — planear CÓMO
- 3 Implementación — construir
- 4 Pruebas — chequear
- 5 Despliegue y mantenimiento — entregar y sostener

### EDT / WBS — Estructura de Desglose del Trabajo (Work Breakdown Structure)
- Se organiza por QUÉ entregar, no por fechas ni por acciones
- Niveles: proyecto → fases → entregables → paquetes de trabajo
- El nivel más bajo es el paquete de trabajo
- Cada fase cierra con al menos un hito

### Paquete de trabajo
- Vive en la EDT
- Es un componente o entregable
- No tiene duración propia

### Regla 8/80
- Menos de 8 h → estás microgestionando
- Más de 80 h → no lo podés estimar ni controlar: hay que partirlo

### Actividad
- Vive en el cronograma
- Es una acción con duración
- Sale de descomponer el paquete

### Cadena de procesos del cronograma
- Definir actividades — ¿qué hay que hacer?
- Secuenciar — ¿en qué orden?
- Estimar recursos — ¿con qué y con quiénes?
...
- Indirectos: benefician a varios proyectos (seguros, administración, impuestos). Se asignan como % sobre los directos
...
- 2 Evaluar su impacto en las tres restricciones: calidad, costo y duración
- 3 Decidir y justificar la decisión
- 4 Pedir aprobación a los interesados
- 5 Actualizar el plan y, si corresponde, la línea base

### Rebaselining
- Se hace cuando hay cambio de alcance aprobado, no cuando el equipo se atrasó
